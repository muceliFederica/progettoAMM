...
<?php if (count($prodotti) > 0) { ?>
				...
				foreach ($prodotti as $prodotto)
			{
                ...
                <tr >
					...
					<td>
						...
						<?= $nome ?><?= $vd->scriviToken('&') ?>" title="Modifica prodotto">
                    ...
                    <td>
						...
						<?= $nome ?><?= $vd->scriviToken('&') ?>" title="Elimina prodotto">
	...
	<div>
		<form method="post" action="index.php?page=datore&subpage=inserisciProdotto<?= $vd->scriviToken('?') ?>">
